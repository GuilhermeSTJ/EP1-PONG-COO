...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		if(getCy() > v_limit[0] + (getHeight()/2)) { // delimita o limite que podemos mexer o player
			this.cy = cy - speed*delta; //modifica a coordenada y do player
			draw();
		}
	}
	...
	*/
	...
	public void moveDown(long delta){
		if(getCy() < v_limit[1] - (getHeight()/2)) { // delimita o limite que podemos mexer o player
			this.cy = cy + speed * delta; //modifica a coordenada y do player
			draw();
		}
	}
